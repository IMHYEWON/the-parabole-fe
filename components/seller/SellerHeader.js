  ...
  return <>
    <header className="text-gray-700 body-font">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <Link href={LINKS.SELLER_MAIN} legacyBehavior>
        ...
        <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
          ...
          <Link href={LINKS.SELLER_PRODUCT_LIST} legacyBehavior>
            <a className="mr-5 hover:text-gray-900">상품</a>
          </Link>
          <Link href={LINKS.SELLER_COUPON_LIST} legacyBehavior>
            <a className="mr-5 hover:text-gray-900">쿠폰</a>
          </Link>
          <Link href={LINKS.SELLER_EVENT_LIST} legacyBehavior>
          ...
          {token ? (
            ...
            <div>
              ...
              <Link href={LINKS.SIGNUP} legacyBehavior>
